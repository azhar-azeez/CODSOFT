    ...
    <div>
      <Menu as='div' className='inline-block text-left'>
        <div className='flex'>
          ...
          py-2 text-sm font-medium text-slate-700 hover:bg-opacity-20'>
        ...
        >
          <Menu.Item className="absolute z-50 right-2 mt-2 w-56 origin-top-right 
          divide-y dividfe-gray-100 rounded-md bg-white shadow-lg focus:outline-none">
            <div className='p-1 '>
              <Menu.Item>
                {({active}) => (
                    <Link
    ...
    items-center justify-between p-5'>
      <div>
        <Link to='/' className='text-blue-600 font-bold text-xl'>
          Job<span className='text-[#1677cccb]'>Nest</span>
          </Link>
      </div>
